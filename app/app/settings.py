...
SECRET_KEY = environ.get("SECRET_KEY", default="well-well-well")
...
if DEBUG:
    ...
    try:
        ...
        print("ALLOWED_HOSTS are not set! Using default instead.")
...
DATABASES = {
    "default": {
        ...
        "NAME": environ.get("DB_NAME", default="filesdb"),
...
CELERY_BROKER_URL = environ.get("CELERY_BROKER_URL", default="redis://redis:6379/0")
